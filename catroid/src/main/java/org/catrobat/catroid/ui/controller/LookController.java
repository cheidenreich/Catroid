...
public final class LookController {
	...
	public static LookData backpackVisible(LookData lookData) {
		BackPackListManager.getInstance().removeItemFromLookBackPackByLookName(lookData.getLookName());
		...
		backpackLookData.setLookName(lookData.getLookName());
	...
	public static LookData backpackHidden(LookData lookData) {
		...
		backpackLookData.setLookName(Utils.getUniqueLookName(lookData, true));
	...
	public static LookData unpackVisible(LookData lookData) {
		...
		lookDataToUnpack.setLookName(Utils.getUniqueLookName(lookData, false));
